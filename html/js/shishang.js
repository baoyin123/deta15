...
//获取需要轮播图片的数据
  ajaxs('../../php/code/index.php?select_text=caseName&select_text2=case_lunboimg=\"ss\"',function(obj) {
   		lunbo(obj);
   });
  ajaxs('../../php/code/index.php?select_text=caseName&select_text2=case_line=\"ss\"',function(obj) {
   		case_list(obj);
   });
    // 获取部分客户的文本信息
